...
ServoInputPin<9> inputServo0;
ServoInputPin<10> inputServo1;
ServoInputPin<11> inputServo2;
ServoInputPin<12> inputServo3;

long pulse[4] = {0, 0, 0, 0};
int waitTime = 100;  // milliseconds (ms)
int toggle = 0;
...
void setup()
{
  ...
  /*
	inputServo0.attach();  // attaches the servo input interrupt
	inputServo1.attach();  // attaches the servo input interrupt
	inputServo2.attach();  // attaches the servo input interrupt
	inputServo3.attach();  // attaches the servo input interrupt
  */
...
void loop()
{
  pulse[0] = inputServo0.getPulseRaw();  // get unfiltered pulse duration
	pulse[1] = inputServo1.getPulseRaw();  // get unfiltered pulse duration
	pulse[2] = inputServo2.getPulseRaw();  // get unfiltered pulse duration
	pulse[3] = inputServo3.getPulseRaw();  // get unfiltered pulse duration
